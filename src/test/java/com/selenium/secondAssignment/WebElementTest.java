...
public class WebElementTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.get("https://pilotprocurement.brac.net/");
        ...
        System.out.println("Print x axis: " + username.getRect().x + "\n" + "Print y axis: " + username.getRect().y);      //Print the dimensions and coordinates by using .getRect()
